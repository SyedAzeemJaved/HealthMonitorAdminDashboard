...
export default function EditDoctor() {
  ...
  const [doctor, setDoctor] = useState<EditDoctorProps>({
    id: 0,
    name: '',
    email: '',
    ...
    try {
      ...
      const res = await fetch(`${constants.USERS}/${id}`, {
        ...
        body: JSON.stringify({
          ...
          additional_details: {
            phone: nullIfEmpty(doctor.additional_details.phone),
      ...
      fireToast('Success', 'Doctor edited successfully', FireToastEnum.SUCCESS);
    } catch (err: any) {
      fireToast(
  ...
  return (
    <>
      <Breadcrumb pageName="Edit Doctor" />
            ...
            <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
              <div className="w-full sm:w-1/2">
                ...
                <input
                  ...
                  value={doctor.additional_details.phone || undefined}
              ...
              <div className="w-full sm:w-1/2">
                ...
                <input
                  ...
                  value={doctor.additional_details.age || undefined}
                  onChange={(e) => handleChangeAdditionalDetails(e)}
                />
              </div>
            </div>
              ...
              <div className="w-full sm:w-1/2">
                ...
                <div className="relative z-20 bg-transparent dark:bg-meta-4">
                  <select
                    ...
                    name="blood_group"
                    id="blood_group"
                    value={doctor.additional_details.blood_group}
                    onChange={(e) => {
