...
export default function EditPatient() {
  ...
  const [patient, setPatient] = useState<EditPatientProps>({
    id: 0,
    name: '',
    email: '',
    ...
    try {
      ...
      const res = await fetch(`${constants.USERS}/${id}`, {
        ...
        body: JSON.stringify({
          ...
          additional_details: {
            phone: nullIfEmpty(patient.additional_details.phone),
  ...
  return (
    <>
      <Breadcrumb pageName="Edit Patient" />
            ...
            <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
              <div className="w-full sm:w-1/2">
                ...
                <input
                  ...
                  value={patient.additional_details.phone || undefined}
              ...
              <div className="w-full sm:w-1/2">
                ...
                <input
                  ...
                  value={patient.additional_details.age || undefined}
                  onChange={(e) => handleChangeAdditionalDetails(e)}
                />
              </div>
            </div>
              ...
              <div className="w-full sm:w-1/2">
                ...
                <div className="relative z-20 bg-transparent dark:bg-meta-4">
                  <select
                    ...
                    name="blood_group"
                    id="blood_group"
                    value={patient.additional_details.blood_group}
                    onChange={(e) => {
